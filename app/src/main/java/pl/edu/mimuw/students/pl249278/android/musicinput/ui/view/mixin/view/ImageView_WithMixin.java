...
public class ImageView_WithMixin extends androidx.appcompat.widget.AppCompatImageView {

    protected ViewGroupStrategy mixin;

    public ImageView_WithMixin(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ImageView_WithMixin(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        mixin.onLayout(changed, l, t, r, b, new ViewGroupStrategy.OnLayoutSuperCall() {
            ...
            public void onLayout(boolean changed, int l, int t, int r, int b) {
                ImageView_WithMixin.super.onLayout(changed, l, t, r, b);
            }
        });
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        mixin.onSizeChanged(w, h, oldw, oldh, new ViewGroupStrategy.OnSizeChangedSuperCall() {
            ...
            public void onSizeChanged(int w, int h, int oldw, int oldh) {
                ImageView_WithMixin.super.onSizeChanged(w, h, oldw, oldh);
            }
        });
    }
    ...
    protected void onDraw(Canvas canvas) {
        mixin.onDraw(canvas, new ViewGroupStrategy.OnDrawSuperCall() {
            ...
            public void onDraw(Canvas canvas) {
                ImageView_WithMixin.super.onDraw(canvas);
            }
        });
    }
    ...
    private ViewGroupStrategy.BuildDrawingCacheSuperCall buildDrawingCacheSuperCall() {
        return new ViewGroupStrategy.BuildDrawingCacheSuperCall() {
            @Override
            public void buildDrawingCache() {
                ImageView_WithMixin.super.buildDrawingCache();
            }

            @Override
            public void buildDrawingCache(boolean autoScale) {
                ImageView_WithMixin.super.buildDrawingCache(autoScale);
            }
        };
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        mixin.onMeasure(widthMeasureSpec, heightMeasureSpec, new ViewGroupStrategy.OnMeasureSuperCall() {
            ...
            public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ImageView_WithMixin.super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            }
        });
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        mixin.onScrollChanged(l, t, oldl, oldt, new ViewGroupStrategy.OnScrollChangedSuperCall() {
            ...
            public void onScrollChanged(int l, int t, int oldl, int oldt) {
                ImageView_WithMixin.super.onScrollChanged(l, t, oldl, oldt);
            }
        });
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        return mixin.dispatchTouchEvent(ev, new ViewGroupStrategy.DispatchTouchEventSuperCall() {
            @Override
            public boolean dispatchTouchEvent(MotionEvent ev) {
                return ImageView_WithMixin.super.dispatchTouchEvent(ev);
            }
        });
    }
    ...
    public void setPadding(int left, int top, int right, int bottom) {
        mixin.setPadding(left, top, right, bottom, new ViewGroupStrategy.SetPaddingSuperCall() {
            @Override
            public void setPadding(int left, int top, int right, int bottom) {
                ImageView_WithMixin.super.setPadding(left, top, right, bottom);
            }
        });
    }
    ...
    protected void onFinishInflate() {
        mixin.onFinishInflate(new ViewGroupStrategy.OnFinishInflateSuperCall() {
            ...
            public void onFinishInflate() {
                ImageView_WithMixin.super.onFinishInflate();
            }
        });
    }
    ...
    public class Internals implements ViewGroupInternals {
        ...
        public void setChildrenDrawingOrderEnabled(boolean enabled) {
            throw new UnsupportedOperationException(ImageView_WithMixin.this + " is mot a view group");
        }

        @Override
        public View viewObject() {
            return ImageView_WithMixin.this;
        }
