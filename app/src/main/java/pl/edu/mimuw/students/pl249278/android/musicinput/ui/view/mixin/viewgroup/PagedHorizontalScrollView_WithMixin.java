...
import pl.echo.android.view.PagedHorizontalScrollView;
...
public class PagedHorizontalScrollView_WithMixin<Mixin extends ViewGroupStrategy> extends PagedHorizontalScrollView {

    protected Mixin mixin;

    public PagedHorizontalScrollView_WithMixin(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PagedHorizontalScrollView_WithMixin(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    protected void initMixin(Mixin mixin, ViewInflationContext viewInflationContext) {
        this.mixin = mixin;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        mixin.onLayout(changed, l, t, r, b, new ViewGroupStrategy.OnLayoutSuperCall() {
            ...
            public void onLayout(boolean changed, int l, int t, int r, int b) {
                PagedHorizontalScrollView_WithMixin.super.onLayout(changed, l, t, r, b);
            }
        });
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        mixin.onSizeChanged(w, h, oldw, oldh, new ViewGroupStrategy.OnSizeChangedSuperCall() {
            ...
            public void onSizeChanged(int w, int h, int oldw, int oldh) {
                PagedHorizontalScrollView_WithMixin.super.onSizeChanged(w, h, oldw, oldh);
            }
        });
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        return mixin.onInterceptTouchEvent(ev, new ViewGroupStrategy.OnInterceptTouchEventSuperCall() {
            @Override
            public boolean onInterceptTouchEvent(MotionEvent ev) {
                return PagedHorizontalScrollView_WithMixin.super.onInterceptTouchEvent(ev);
            }
        });
    }
    ...
    protected int getChildDrawingOrder(int childCount, int i) {
        return mixin.getChildDrawingOrder(childCount, i, new ViewGroupStrategy.GetChildDrawingOrderSuperCall() {
            ...
            public int getChildDrawingOrder(int childCount, int i) {
                return PagedHorizontalScrollView_WithMixin.super.getChildDrawingOrder(childCount, i);
            }
        });
    }
    ...
    protected void onDraw(Canvas canvas) {
        mixin.onDraw(canvas, new ViewGroupStrategy.OnDrawSuperCall() {
            ...
            public void onDraw(Canvas canvas) {
                PagedHorizontalScrollView_WithMixin.super.onDraw(canvas);
            }
        });
    }
    ...
    private ViewGroupStrategy.BuildDrawingCacheSuperCall buildDrawingCacheSuperCall() {
        return new ViewGroupStrategy.BuildDrawingCacheSuperCall() {
            @Override
            public void buildDrawingCache() {
                PagedHorizontalScrollView_WithMixin.super.buildDrawingCache();
            }

            @Override
            public void buildDrawingCache(boolean autoScale) {
                PagedHorizontalScrollView_WithMixin.super.buildDrawingCache(autoScale);
            }
        };
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        mixin.onMeasure(widthMeasureSpec, heightMeasureSpec, new ViewGroupStrategy.OnMeasureSuperCall() {
            ...
            public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                PagedHorizontalScrollView_WithMixin.super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            }
        });
    }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        mixin.onScrollChanged(l, t, oldl, oldt, new ViewGroupStrategy.OnScrollChangedSuperCall() {
            ...
            public void onScrollChanged(int l, int t, int oldl, int oldt) {
                PagedHorizontalScrollView_WithMixin.super.onScrollChanged(l, t, oldl, oldt);
            }
        });
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        return mixin.dispatchTouchEvent(ev, new ViewGroupStrategy.DispatchTouchEventSuperCall() {
            @Override
            public boolean dispatchTouchEvent(MotionEvent ev) {
                return PagedHorizontalScrollView_WithMixin.super.dispatchTouchEvent(ev);
            }
        });
    }
    ...
    public void setPadding(int left, int top, int right, int bottom) {
        mixin.setPadding(left, top, right, bottom, new ViewGroupStrategy.SetPaddingSuperCall() {
            @Override
            public void setPadding(int left, int top, int right, int bottom) {
                PagedHorizontalScrollView_WithMixin.super.setPadding(left, top, right, bottom);
            }
        });
    }
    ...
    protected void onFinishInflate() {
        mixin.onFinishInflate(new ViewGroupStrategy.OnFinishInflateSuperCall() {
            ...
            public void onFinishInflate() {
                PagedHorizontalScrollView_WithMixin.super.onFinishInflate();
            }
        });
    }
    ...
    public class Internals implements ViewGroupInternals {
        ...
        public void setChildrenDrawingOrderEnabled(boolean enabled) {
            PagedHorizontalScrollView_WithMixin.super.setChildrenDrawingOrderEnabled(enabled);
        }

        @Override
        public View viewObject() {
            return PagedHorizontalScrollView_WithMixin.this;
        }
